...
/**
 * This class constructs a frame for the hard level
 * <p>
 * The class runs a hard level frame
 *
 ...
 */
	...
	public class Level3 extends JFrame {
		...
		public Level3() {
			...
			bte_check.setIcon(new ImageIcon(Level3.class.getResource("/Guessus/Pics/check2.png")));
			bte_check.setBounds(436, 518, 78, 38);
			...
			btn_main.setIcon(new ImageIcon(Level3.class.getResource("/Guessus/Pics/backtomenu.png")));
			...
			label_clue.setBounds(520, 566, 197, 38);
			contentPane.add(label_clue);
			btn_clue.setIcon(new ImageIcon(Level3.class.getResource("/Guessus/Pics/clue2.png")));
			btn_clue.setBounds(436, 566, 78, 38);
			contentPane.add(btn_clue);
			
			label_minus40 = new JLabel("");
			label_minus40.setAlignmentX(Component.RIGHT_ALIGNMENT);
			label_minus40.setIcon(new ImageIcon(Level3.class.getResource("/Guessus/Pics/minus40.png")));
			label_minus40.setBounds(322, 13, 70, 75);
			contentPane.add(label_minus40);
			label_minus40.setVisible(false);
			
			JLabel label_minus10 = new JLabel("");
			label_minus10.setIcon(new ImageIcon(Level3.class.getResource("/Guessus/Pics/minu10.png")));
			label_minus10.setBounds(322, 0, 78, 100);
			...
			text_answer.setBounds(510, 518, 207, 38);
