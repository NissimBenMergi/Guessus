	...
	/**
	 * This class constructs a frame for the casual level
	 * <p>
	 * The class runs a casual level frame
	 *
 ...
 * <p>
 * The class runs a easy level frame
 *
 * @author  Lior Chausovski
 * @author  Nissim Ben-Mergi 
 * 
 */
	public class Level2 extends JFrame {
		...
		public Level2() {
			...
			bte_check.setIcon(new ImageIcon(Level2.class.getResource("/Guessus/Pics/check2.png")));
			bte_check.setBounds(418, 547, 78, 38);
			...
			btn_main.setIcon(new ImageIcon(Level2.class.getResource("/Guessus/Pics/backtomenu.png")));
			...
			text_answer.setBounds(496, 547, 224, 38);
			...
			label_clue.setBounds(496, 598, 224, 38);
			contentPane.add(label_clue);
			btn_clue.setIcon(new ImageIcon(Level2.class.getResource("/Guessus/Pics/clue2.png")));
			btn_clue.setBounds(418, 598, 78, 38);
			contentPane.add(btn_clue);
			
			label_minus40 = new JLabel("");
			label_minus40.setIcon(new ImageIcon(Level2.class.getResource("/Guessus/Pics/minus40.png")));
			label_minus40.setBounds(323, 13, 70, 78);
			contentPane.add(label_minus40);
			label_minus40.setVisible(false);
			
			JLabel label_minus10 = new JLabel("");
			label_minus10.setIcon(new ImageIcon(Level2.class.getResource("/Guessus/Pics/minu10.png")));
			label_minus10.setBounds(323, 0, 78, 103);
